...
vUoldr = mxGetDoubles(prhs[0]);
if(mxIsComplex(prhs[0])){
	vUoldi = (double *)mxGetComplexDoubles(prhs[0]);
}
else{
...
Unewr = mxGetDoubles(plhs[0]);
Unewi = (double *)mxGetComplexDoubles(plhs[0]);
